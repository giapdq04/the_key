...
const ReusableModal = ({ isOpen, onClose, title, defaultName, defaultAltName, onSave }) => {
    ...
    return (
        <div className={cx("overlay")} onClick={onClose}>
            <div className={cx("modal")} onClick={(e) => e.stopPropagation()}>
                ...
                <label className={cx("input-label")}>Tên khác</label>
                <input 
                    type="text" 
                    placeholder="Nhập tên khác của bạn" 
                    value={altName} 
